...
func main() {
	...
	//client, _ := mongo.Connect(ctx, options.Client().ApplyURI("mongodb+srv://"+os.Getenv("MONGODB_USER")+":"+os.Getenv("MONGODB_PASSWD")+"@cluster0.ykdp5.mongodb.net/myFirstDatabase?retryWrites=true&w=majority"))
